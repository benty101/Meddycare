...
Write-Host "✅ Fixed .env file with correct pooler URLs" -ForegroundColor Green
Write-Host "✅ DATABASE_URL: Transaction pooler (port 6543)" -ForegroundColor Green
Write-Host "✅ DIRECT_URL: Session pooler (port 5432)" -ForegroundColor Green
Write-Host "✅ Both using aws-1-eu-west-1.pooler.supabase.com" -ForegroundColor Green
